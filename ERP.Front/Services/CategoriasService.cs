...
public class CategoriasService
{
    ...
    public CategoriasService(HttpClient httpClient, IJSRuntime jsRuntime)
    {
    ...
    public async Task<Categoria?> CreateAsync(CategoriaForm categoria)
    {
        var token = await GetTokenAsync();
    ...
    public async Task<Categoria?> UpdateAsync(Guid id, CategoriaForm categoria)
    {
